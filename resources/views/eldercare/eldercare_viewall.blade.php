		...
		<div class="box-content">
			...
			<div class="tab">
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="{{ url('/eldercare/eldercare_details_eldercare') }}">Eldercare</a></li>
				</ul>
				<div class="tab-content">
							...
							<div class="col-md-3">
								<div class="box-services services-orange">
									<div class="services-header">
										<h6>Eldercare</h6>
										<h3>Eldercare Plan</h3>
									</div>
									<div class="services-content">
										<div class="services-content-row">
											<div class="services-column services-column-full text-center"> <img src="{{ url('dashboard/img/icon-eldercare.png') }}" alt="" title=""/> </div>
										</div>
									</div>
							...
							<div class="col-md-3">
								<div class="box-add-charity">
									<div class="add-charity-content">
										<h3>Add <span>a eldercare</span></h3>
					...
					<div role="tabpanel" class="tab-pane" id="eldercare"></div>
				</div>
			</div>
		</div>
@endsection 