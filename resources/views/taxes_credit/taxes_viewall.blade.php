		...
		<div class="box-content">
			...
			<div class="tab">
				<ul class="nav nav-tabs" role="tablist">
					...
					<li role="presentation"><a href="{{ url('/taxescredit/taxes_details_taxreturns') }}">Tax Returns </a></li>
					<li role="presentation"><a href="#creditreports" aria-controls="creditreports" role="tab" data-toggle="tab">Credit Reports</a></li>
				</ul>
				<div class="tab-content">
								...
								<div class="box-services services-pink">
									...
									<div class="services-content">
										<div class="services-content-row">
											<div class="services-column services-column-full text-center"> <img src="{{ url('dashboard/img/icon-tax-return.png') }}" alt="" title=""/> </div>
										</div>
									</div>
					...
					<div role="tabpanel" class="tab-pane" id="taxreturns"></div>
					<div role="tabpanel" class="tab-pane" id="creditreports"></div>
				</div>
			</div>
		</div>
@endsection