        ...
        <div class="box-questionnaire-container">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-7">
					...
					{!! Form::open(['url' => '/home/addStep4', 'enctype' => 'multipart/form-data', 'class' => 'style-form', 'role' => 'form', 'method' => 'POST', 'id' => 'addStep4'] ) !!}
						...
						<div class="form-details">
							...
							<div class="btn-row">
								...
								{!! Form::button('Continue', ['type' => 'button', 'class' => 'btn btn-primary', 'onClick' => 'fourthSteps();']) !!}
							</div>
						</div>
					{!! Form::close() !!}
                </div>
...
<script type="text/javascript">
	function fourthSteps(){
		var valid;	
		valid = validateForm();
		if(valid) {
			$('form#addStep4').submit();
		}
	}
	
	function validateForm(){
		var valid 				= true;	
		var health_care_planning 	= $('#health_care_planning').val();
		
		var inputVal = new Array(health_care_planning);
		
		if(inputVal[0] == ""){
			$("button[data-id='health_care_planning']").css('border', '1px solid #A94442');
			$("button[data-id='health_care_planning']").parent().css('color', '#A94442');
			valid = false;
		}else{
			$("button[data-id='health_care_planning']").css('border', '1px solid green');
			$("button[data-id='health_care_planning']").parent().css('color', 'green');
		}
